...
int main()
{
    Eigen::Matrix3f rot1 = mathext::rot_align_normal(Eigen::Vector3f(0, -1.0f, 0));
    ...
    Eigen::Matrix3f rot2 = mathext::rot_align_normal(Eigen::Vector3f(0, 1.0f, 1.0f).normalized());
    ...
    Eigen::Matrix3f rot3 = mathext::rot_align_normal(Eigen::Vector3f(0, 0, 1.0f));
